...
进入本项目 `v1` 目录后使用 PowerShell，Python 3.10；已安装 Icarus 和 Vivado 的路径可通过参数覆盖。
...
最新结果以 [交接](../shared/HANDOFF.md)、[验收矩阵](../shared/ACCEPTANCE.md)、[当前报告](../shared/report_v1.md) 指向的证据为准。
