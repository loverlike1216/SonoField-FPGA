...
All numerical results are **SIMULATION_ESTIMATE**. Do not compare arbitrary pressure units between
different real transducer types as if their source strengths had been measured equal.
...
Current outputs: evidence/model/. Coordinate and phase tables:
