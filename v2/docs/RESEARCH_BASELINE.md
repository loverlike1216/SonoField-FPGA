...
| User image tb_image_share_1789778175070.png | Current nominal 10 mm mechanical reference and 40 kHz label | Exact part, voltage, capacitance, active aperture and formal tolerances absent; see hardware/transducers/10mm_supplier_reference.md |
...
| [TCT40 component sheet hosted by SparkFun](https://docs.sparkfun.com/SparkFun_Ultrasonic_Distance_Sensor-Qwiic/assets/component_documentation/TCT40-16-T-R.pdf) | Historical 16 mm reference only | Must not transfer its electrical ratings to the current 10 mm candidate |
