> Inherited digital/prototype reference. Formal v2 hardware requirements and hardware/bom/BOM_LOCK.md supersede component, power and physical-stage proposals here. No hardware capability is implemented by this migration.
...
No bridge PCB or 128-channel component values are frozen in v2.
...
`evidence/model/channel_mapping.csv` specifies logical identities, not board/header pin assignments.
